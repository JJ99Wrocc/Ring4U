...
import '../css/earRings.css';
    ...
    const BranceletHandFake = ({ category }) => {



    const { subcategory } = useParams();
    console.log("Kategoria:", category);
    console.log("Dane produktów:", bransoletkaRekaSztuczna);
    ...
    const filteredProducts = bransoletkaRekaSztuczna.filter(p => 
        p.category === "sztuczna" && 
...
return <div className="container">Brak produktów w tej kategorii.</div>;
    ...
    return (
      ...
      <h1 className="ear-v2-title">Branzoletki Na Dłonie {subcategory ? `- ${subcategory}` : '- Fashions'}</h1>
...
{selectedImage && (
    ...
    export default BranceletHandFake;