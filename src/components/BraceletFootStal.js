...
import '../css/earRings.css';
    ...
    const BranceletFootStal = ({ category }) => {



    const { subcategory } = useParams();
    console.log("Kategoria:", category);
    console.log("Dane produktów:", branzoletkiStopyStal);
    ...
    const filteredProducts = branzoletkiStopyStal.filter(p => 
        p.category === "stal" && 
...
return <div className="container">Brak produktów w tej kategorii.</div>;
    ...
    return (
      ...
      <h1 className="ear-v2-title">Branzoletki Na Stopy {subcategory ? `- ${subcategory}` : '- Stal'}</h1>
...
{selectedImage && (
    ...
    export default BranceletFootStal;