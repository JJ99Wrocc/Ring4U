...
import '../css/earRings.css';
    ...
    const BranceletFootFake = ({ category }) => {



    const { subcategory } = useParams();
    console.log("Kategoria:", category);
    console.log("Dane produktów:", branzoletkaStopaSztuczna);
    ...
    const filteredProducts = branzoletkaStopaSztuczna.filter(p => 
        p.category === "sztuczna" && 
...
return <div className="container">Brak produktów w tej kategorii.</div>;
    ...
    return (
      ...
      <h1 className="ear-v2-title">Branzoletki Na Stopy {subcategory ? `- ${subcategory}` : '- Fashions'}</h1>
...
{selectedImage && (
    ...
    export default BranceletFootFake;